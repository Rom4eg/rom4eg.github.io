...
var _appearanceStore = require("../lib/modules/themes/appearance.store");
var _appearanceStoreDefault = parcelHelpers.interopDefault(_appearanceStore);
var _themeSwitcherData = require("../lib/modules/themes/theme-switcher.data");
var _themeSwitcherDataDefault = parcelHelpers.interopDefault(_themeSwitcherData);
var _bookmarksStore = require("./../lib/modules/bookmarks/bookmarks.store");
var _bookmarksStoreDefault = parcelHelpers.interopDefault(_bookmarksStore);
var _navStore = require("../lib/modules/sidebar/nav.store");
var _navStoreDefault = parcelHelpers.interopDefault(_navStore);
var _panelStore = require("./../lib/modules/panel/panel.store");
var _panelStoreDefault = parcelHelpers.interopDefault(_panelStore);
var _searchData = require("./../lib/modules/search/search.data");
var _searchDataDefault = parcelHelpers.interopDefault(_searchData);
var _collapsibleData = require("../lib/shared/collapsible.data");
var _collapsibleDataDefault = parcelHelpers.interopDefault(_collapsibleData);
var _hotkeysStore = require("../lib/shared/hotkeys.store");
var _hotkeysStoreDefault = parcelHelpers.interopDefault(_hotkeysStore);
var _scrollPositionData = require("../lib/shared/scroll-position.data");
var _scrollPositionDataDefault = parcelHelpers.interopDefault(_scrollPositionData);
var _windowScrollBind = require("../lib/shared/window-scroll.bind");
var _windowScrollBindDefault = parcelHelpers.interopDefault(_windowScrollBind);
var _persistPlugin = require("../lib/shared/persist.plugin");
var _persistPluginDefault = parcelHelpers.interopDefault(_persistPlugin);
var _copyToClipboardData = require("../lib/shared/copy-to-clipboard.data");
var _copyToClipboardDataDefault = parcelHelpers.interopDefault(_copyToClipboardData);
var _tocData = require("./../lib/modules/toc/toc.data");
var _tocDataDefault = parcelHelpers.interopDefault(_tocData);
(0, _alpinejsDefault.default).plugin((0, _persistPluginDefault.default));
(0, _appearanceStoreDefault.default)((0, _alpinejsDefault.default));
(0, _themeSwitcherDataDefault.default)((0, _alpinejsDefault.default));
(0, _bookmarksStoreDefault.default)((0, _alpinejsDefault.default));
(0, _navStoreDefault.default)((0, _alpinejsDefault.default));
(0, _panelStoreDefault.default)((0, _alpinejsDefault.default));
(0, _searchDataDefault.default)((0, _alpinejsDefault.default));
(0, _collapsibleDataDefault.default)((0, _alpinejsDefault.default));
(0, _hotkeysStoreDefault.default)((0, _alpinejsDefault.default));
(0, _scrollPositionDataDefault.default)((0, _alpinejsDefault.default));
(0, _windowScrollBindDefault.default)((0, _alpinejsDefault.default));
(0, _copyToClipboardDataDefault.default)((0, _alpinejsDefault.default));
(0, _tocDataDefault.default)((0, _alpinejsDefault.default));
(0, _alpinejsDefault.default).start();

},{"alpinejs":"69hXP","../lib/modules/themes/appearance.store":"eRGgB","../lib/modules/themes/theme-switcher.data":"hKylk","./../lib/modules/bookmarks/bookmarks.store":"fxtmS","../lib/modules/sidebar/nav.store":"jnX3J","./../lib/modules/panel/panel.store":"iBJmi","./../lib/modules/search/search.data":"9YWcp","../lib/shared/collapsible.data":"bVIQk","../lib/shared/hotkeys.store":"2BsB4","../lib/shared/scroll-position.data":"4SKkU","../lib/shared/window-scroll.bind":"dZiII","../lib/shared/persist.plugin":"16z5S","../lib/shared/copy-to-clipboard.data":"kFWT5","./../lib/modules/toc/toc.data":"k2Rrw","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"69hXP":[function(require,module,exports,__globalThis) {
...
},{}],"eRGgB":[function(require,module,exports,__globalThis) {
/**
 ...
 */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>function(Alpine) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hKylk":[function(require,module,exports,__globalThis) {
/**
...
parcelHelpers.export(exports, "default", ()=>function(Alpine) {
        Alpine.data("themeSwitcher", ()=>({
                ...
                onFocusOut (event) {
                    if (this.open && !this.$refs.menu.contains(event.relatedTarget)) this.$nextTick(()=>this.closeMenu({
                            restoreFocus: false
                        }));
                },
                focusNext () {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fxtmS":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/**
 ...
 */ parcelHelpers.export(exports, "default", ()=>function(Alpine) {
     ...
     */ items: Alpine.$persist([]).as("favorites"),
            async init () {
                this.index = await fetch(indexJsonUrl).then((r)=>r.json()).catch(()=>{
     ...
     * @param {string} id
     */ toggle (id) {
                if (this.items.includes(id)) this.items = this.items.filter((bkm)=>bkm !== id);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jnX3J":[function(require,module,exports,__globalThis) {
/**
...
parcelHelpers.export(exports, "default", ()=>function(Alpine) {
        Alpine.store("nav", {
            ...
            toggle (value) {
                ...
                if (this.open) Alpine.store("panel").toggle(false);
            }
        });
    });

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iBJmi":[function(require,module,exports,__globalThis) {
/**
        ...
        Alpine.store("panel", {
            ...
            init () {
                ...
                observeMediaQuery("(min-width: 64em)", (matches)=>{
                    ...
                    if (source.firstElementChild) target.append(source.firstElementChild);
                });
            },
            onOverlayClick (event) {
                const isSelf = event.target === event.currentTarget;
                const isSameTabLink = event.target.tagName === "A" && event.target.getAttribute("target") !== "_blank";
                this.toggle(!(isSelf || isSameTabLink));
            },
            toggle (value) {
                this.open = value ?? !this.open;
                if (this.open) Alpine.store("nav").toggle(false);
            }
        });
    });
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9YWcp":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/**
 ...
 */ parcelHelpers.export(exports, "default", ()=>function(Alpine) {
        Alpine.data("search", ()=>({
                ...
                async fetchNotes () {
                    if (!this._notes) this._notes = new Promise(async (resolve)=>{
                ...
                async loadPagefind () {
                    if (!this._pagefind) this._pagefind = new Promise(async (resolve)=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bVIQk":[function(require,module,exports,__globalThis) {
/**
...
parcelHelpers.export(exports, "default", ()=>function(Alpine) {
        Alpine.data("collapsible", (key, defaultExpanded)=>({
                expanded: Alpine.$persist(defaultExpanded).as(`collapsible:${key}`).using(sessionStorage),
                init () {
                    if (this.$el.querySelector("[aria-current=page]")) this.expanded = true;
                },
                toggle () {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2BsB4":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/**
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4SKkU":[function(require,module,exports,__globalThis) {
/**
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dZiII":[function(require,module,exports,__globalThis) {
/**
...
parcelHelpers.export(exports, "default", ()=>function(Alpine) {
        Alpine.bind("WindowScroll", ()=>({
                ["@scroll.window"] () {
                    this.$el.setAttribute("data-scrolled", window.document.documentElement.scrollTop > 0);
                }
            }));
    });

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"16z5S":[function(require,module,exports,__globalThis) {
/**
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kFWT5":[function(require,module,exports,__globalThis) {
/**
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"k2Rrw":[function(require,module,exports,__globalThis) {
/**
...
parcelHelpers.export(exports, "default", ()=>function(Alpine) {
        Alpine.data("toc", ()=>({
                ...
                init () {
                    ...
                    this._headings = this._links.map((link)=>link.getAttribute("href").slice(1)).map((id)=>document.getElementById(id));
                ...
                onScroll (throttled = true) {
                    ...
                    if (throttled) // We throttle the onScroll event for better performance (via AlpineJS).
                ...
                _calcPosition () {
                    ...
                    this.activeId = headings.filter((x)=>x.isInFocusAreaOrAbove).sort((a, b)=>b.pos - a.pos).at(0)?.id ?? null;
                },
                _getValidIdFromNextHash (validIds) {
                    const isValid = !!this._nextHash && validIds.includes(this._nextHash) && // Reloading the page with a hash will not focus the heading
                ...
                _calcIndicator () {
                    ...
                    const activeLink = this.activeId ? this._links.find((x)=>x.getAttribute("href") == activeHref) : undefined;
                    if (!activeLink) {
                        this.indicator = {
                            start: 0,
                            size: 0
                ...
                _calcTopOffset () {
                    ...
                    const style = this._headings.length ? window.getComputedStyle(this._headings[0]) : undefined;
                    return style ? parseInt(style.scrollMarginBlockStart, 10) : 0;
                }
            }));
    });

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["5AKj5"], "5AKj5", "parcelRequire1442", {})
